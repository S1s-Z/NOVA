...
def _get_sentence_tokenizer():
  ...
  # nltk.data.path.insert(0, '/mnt/public/shuzhengsi/factuality/FActScore/factscore/nltk_data')
  return nltk.data.load("nltk:/mnt/public/shuzhengsi/factuality/FActScore/factscore/nltk_data/tokenizers/punkt/english.pickle")
