...
class Retrieval(object):
    ...
    def load_encoder(self):
        ...
        encoder = SentenceTransformer("/mnt/public/shuzhengsi/factuality/models/models--sentence-transformers--gtr-t5-large/snapshots/a2c8ac47f998531948d4cbe32a0b577a7037a5e3")
    ...
    def get_gtr_passages(self, topic, retrieval_query, passages, k):
        ...
        if topic in self.embed_cache:
            ...
            # print(inputs)
            # passage_vectors = self.encoder.encode(inputs, batch_size=1, device='cuda:0')
            passage_vectors = self.encoder.encode(inputs, batch_size=self.batch_size, device='cuda:0')
